...
from app_v1.database.repository.user_preference_repository import UserPreferenceRepository
...
class UserPreferencesService():
    ...
    def __init__(self, database_client:BaseDatabaseClient):
        ...
        self._user_preference_repository = UserPreferenceRepository(self._database_client)
