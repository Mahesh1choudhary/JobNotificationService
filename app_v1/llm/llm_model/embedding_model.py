...
from app_v1.config.config_keys import OPENAI_API_KEY, EMBEDDING_MODEL_MAX_CONCURRENT_CALLS
...
class EmbeddingModel():
    ...
    def __init__(self):
        ...
        self._max_concurrent_calls = fetch_key_value(EMBEDDING_MODEL_MAX_CONCURRENT_CALLS, int)
